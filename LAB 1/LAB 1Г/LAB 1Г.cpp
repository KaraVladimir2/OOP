...
void MASTER::set_name_master(const string& n) {
    name = n;
}

void MASTER::set_name_dog(const string& n, const int& k) {
    dogs[k].set_dog_name(n);
}

void MASTER::set_weight(const int& w, const int& k) {
    dogs[k].set_dog_weight(w);
}

void MASTER::set_age(const int& a, const int& k) {
    dogs[k].set_dog_age(a);
}
